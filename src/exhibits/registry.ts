...
export const exhibits: ExhibitMeta[] = [
  {
    ...
    accuracyNotes: [
      ...
      "MU/TH/UR sounds like herself: the boot rumble, matrix beeps, selection sweep and line-printer bursts are lifted from the film scenes the animations were timed against, so each cue runs exactly its phase. The chamber's room tone loops constantly underneath, so the cues are spectrally de-hummed to sit on it. Keystrokes borrow the matrix tick — the film never mics the keyboard clean.",
